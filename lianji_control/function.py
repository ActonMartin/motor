...
class TouchScreen:
    ...
    def reverselowhigh(self,data_in):
        """
        传入data = '00059540'
        返回 95400005
        """
    ...
    def readcoilstatus(self,slave_addr,start_addr,number):
        """
            功能码01 读取线圈（端子）状态
...
if __name__ == "__main__":
    ...
    # kk = lianjicontrol('01').turnoffmotor('ax')
    # print(kk)
    kj = TouchScreen('01').write_multi_registers(4,'99;99;99;99;99;99')
    print(kj)
