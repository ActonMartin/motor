...
from path_planning.path_file import get_path_planning
...
def control_xyz(slave_id):
    xy_coordinate = get_path_planning()
    for coordinate in xy_coordinate:
        x,y = coordinate[0],coordinate[1]
        slave_id.go_straight(x,y,z=None,a=None)
...
if __name__ == "__main__":
    slave1 = Slave('COM4','01')
    slave1.write_single_register(90,1600) # 设置x轴细分
    slave1.write_single_register(92, 1600)  # 设置y轴细分
    slave1.write_single_register(94, 12800)  # 设置z轴细分
    # slave1.write_single_register(96, 3200)  # 设置a轴细分
